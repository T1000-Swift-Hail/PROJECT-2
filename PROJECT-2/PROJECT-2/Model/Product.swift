...
struct Product {
    ...
    func getProducts() -> [Product] {
        ...
        var productAddias = Product(productType: .tshirt, productName: NSLocalizedString("T-shirt", comment: ""), price: 600, quantity: 18, productSize: .l, productBrand: .addias, productColor: .blue, uiImage: UIImage(named: "1")!, tshirtImage: UIImage(named: "addias black shirt")!)
