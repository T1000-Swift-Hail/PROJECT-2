...
class ListofbrandsTableViewController: UITableViewController {
    ...
    let products = ["addias","Niki","Puma","kswiss"]
    let profileImages = [UIImage(named: "1"),UIImage(named: "2"),UIImage(named: "3"),UIImage(named: "4")]
    //let tshirtImages = [ UIImage(named: "55")]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.nameClothing.text = products[indexPath.row]
        cell.profileImage.image = profileImages[indexPath.row]
//        cell.tshirtImage.image = tshirtImages[indexPath.row]
